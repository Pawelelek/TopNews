...
namespace Walter.Web.Controllers
{
    ...
    public class DashboardController : Controller
    {
        ...
        private readonly DashboardAccessService _dashboardAccessService;

        public DashboardController(UserService userService, DashboardAccessService dashboardAccessService)
        {
            _userService = userService;
            _dashboardAccessService = dashboardAccessService;
        }
        ...
        {
            var ipAddress = HttpContext.Connection.RemoteIpAddress?.ToString();// - ipaddress for user
